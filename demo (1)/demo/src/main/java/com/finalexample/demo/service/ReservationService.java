...
public class ReservationService {
    ...
    public MyReservationsResponse getReservationsByUsername(String username, Pageable pageable){
        ...
        List<ReservationResponse>reservationResponses= reservationPage.get().map(this::buildReservationResponse).collect(Collectors.toList());
    ...
    public boolean addReservation(AddReservationRequest addReservationRequest){
        ...
        BigDecimal dateDifferneceB=new BigDecimal(dateDifference);
        BigDecimal totalPrice=pricePerDay.multiply(dateDifferneceB);
        reservation.setTotalPrice(totalPrice);
        reservationRepository.save(reservation);
        return true;
    }
    private boolean isOverlapReservation(LocalDate startDateB, LocalDate endDateB,Long listingId){
        return reservationRepository.findOverlappingReservation(listingId,startDateB,endDateB).isPresent();
    ...
    // gets date as string as parameter
